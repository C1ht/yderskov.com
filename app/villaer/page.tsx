...
const projectGalleries = [
  {
    ...
    images: [
      ...
      { src: "/images/Karetmagervej/Sæby-ny-villa-funkis-køkken.webp", alt: "Køkken i funkisvilla, Sæby — Yderskov Arkitekter" },
      { src: "/images/Karetmagervej/Sæby-ny-villa-funkis-køkken-stue.webp", alt: "Køkken mod stue i funkisvilla, Sæby — Yderskov Arkitekter" },
      { src: "/images/Karetmagervej/Sæby-ny-villa-funkis-køkken-spiseplads.webp", alt: "Køkken-alrum og spiseplads, Sæby — Yderskov Arkitekter" },
      { src: "/images/Karetmagervej/Sæby-ny-villa-funkis-bad.webp", alt: "Badeværelse med fliser, Sæby — Yderskov Arkitekter" },
      { src: "/images/Karetmagervej/Sæby-ny-villa-funkis-gang.webp", alt: "Gang med ovenlys, Sæby — Yderskov Arkitekter" },
      { src: "/images/Karetmagervej/Sæby-ny-villa-funkis-haveside-2.webp", alt: "Haveside og terrasse, Sæby — Yderskov Arkitekter" },
    ],
    dark: false,
  },
  {
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/Lerstien/Frederikshavn-lerstien-søjle.webp", alt: "Strukturelle detaljer og søjle, udsigtsvilla i Frederikshavn — Yderskov Arkitekter" },
      { src: "/images/Lerstien/Frederikshavn-lerstien-terrasse-2.webp", alt: "Terrasse og facade, udsigtsvilla i Frederikshavn — Yderskov Arkitekter" },
    ],
    dark: false,
  },
  {
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/Ikarosvej/Ikarosvej facade.webp", alt: "Engelsk villa i colonial-stil, facade, Aalborg — Yderskov Arkitekter" },
      { src: "/images/Ikarosvej/Ikarosvej forhave med vin.webp", alt: "Forhave ved engelsk villa i colonial-stil, Aalborg — Yderskov Arkitekter" },
      { src: "/images/Ikarosvej/ikarosvej facade mod have.webp", alt: "Haveside på engelsk villa i colonial-stil, Aalborg — Yderskov Arkitekter" },
      { src: "/images/Ikarosvej/ikarosvej hall.webp", alt: "Hall i engelsk villa i colonial-stil, Aalborg — Yderskov Arkitekter" },
    ],
    dark: true,
  },
  {
    ...
    images: [
      { src: "/images/Nørholmsvej/Engelsk villa facade Nørholmsvej.webp", alt: "Engelsk villa på hesteejendom, facade, Nørholm — Yderskov Arkitekter" },
      { src: "/images/Nørholmsvej/Engelsk villa fra havesiden.webp", alt: "Haveside på engelsk villa ved fjorden, Nørholm — Yderskov Arkitekter" },
      { src: "/images/Nørholmsvej/Engelsk villa fra gavl.webp", alt: "Gavl på engelsk villa ved fjorden, Nørholm — Yderskov Arkitekter" },
      { src: "/images/Nørholmsvej/Engelsk villa på stor plæne.webp", alt: "Engelsk villa ved fjorden på stor plæne, Nørholm — Yderskov Arkitekter" },
    ],
    dark: false,
  },
];
