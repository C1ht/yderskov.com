      ...
      <section className="s s-off" style={{ borderTop: "1px solid var(--border)" }}>
        <div className="s-inner">
          <div className="text-2col">
            ...
            <div>
              <p className="body-p">
                 Som en veletableret <strong>tegnestue Nordjylland</strong> har Yderskov gennem mere end 15 år hjulpet private bygherrer med at realisere deres boligdrømme. Vi har base i Brønderslev, og som <strong>arkitekt Nordjylland</strong> tegner og opfører vi unikke huse i Aalborg, Hjørring, Frederikshavn og i hele den nordjyske region. Vores dybe lokalkendskab til de gældende lokalplaner og de enkelte kommuners byggesagsbehandling sikrer dig en tryg og smidig proces fra de første skitser til det færdige myndighedsprojekt.
              </p>
              <p className="body-p">
